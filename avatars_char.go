...
func GetSteveBytes() (*bytes.Buffer, error) {
	steveImgBytes, err := base64.StdEncoding.DecodeString(CharBase64)
	if err != nil {
...
func FetchImageForChar() (image.Image, error) {
