...
func TestSetup(t *testing.T) {
	...
	apiProfiles = map[string]string{
		...
		"MalformedTexture": `{"id":"00000000000000000000000000000004","name":"MalformedTexture"}`,
		...
		"BrokenSTexture":   `{"id":"00000000000000000000000000000008","name":"BrokenSTexture"}`,
		"BrokenCTexture":   `{"id":"00000000000000000000000000000009","name":"BrokenCTexture"}`,
	}
	...
	sessionProfiles = map[string]string{
		...
		"00000000000000000000000000000004": `{"id":"00000000000000000000000000000004","name":"MalformedTexture","properties":[{"name":"textures","value":"NeedsMoreBase"}]}`,
		...
		"00000000000000000000000000000008": `{"id":"00000000000000000000000000000008","name":"BrokenSTexture","properties":[{"name":"textures","value":"eyJ0aW1lc3RhbXAiOjAsInByb2ZpbGVJZCI6IjAwMDAwMDAwMDAwMDAwMDAwMDAwMDAwMDAwMDAwMDA4IiwicHJvZmlsZU5hbWUiOiJCcm9rZW5TVGV4dHVyZSIsInRleHR1cmVzIjp7IlNLSU4iOnsidXJsIjoiaHR0cDovL3RleHR1cmVzLm1pbmVjcmFmdC5uZXQvdGV4dHVyZS9EdWQifX19"}]}`,
		"00000000000000000000000000000009": `{"id":"00000000000000000000000000000009","name":"BrokenCTexture","properties":[{"name":"textures","value":""}]}`,
	}
...
func TestTemp2(t *testing.T) {
	Convey("Test GetUUID", t, func() {
		...
		Convey("Test web request", func() {
			apiRequest, err := apiRequest("http://textures.minecraft.net/texture/c3af7fb821254664558f28361158ca73303c9a85e96e5251102958d7ed60c4a3")

			contents, err := ioutil.ReadAll(apiRequest)
			if err != nil {
				fmt.Printf("%s", err)
				os.Exit(1)
			}
